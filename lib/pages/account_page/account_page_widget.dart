...
class AccountPageWidget extends StatefulWidget {
  /// Create a page which is a user profile page. It shoudlhave animage field.
  /// In that user can choose avatars. There should be edit profile button. ALso
  /// Show the active plan. THe card shoudl contain name of active plan, kWh of
  /// the plan, Price of plan, and plan Validity. Logout Button too.
