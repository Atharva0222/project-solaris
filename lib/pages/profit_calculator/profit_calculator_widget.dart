...
class ProfitCalculatorWidget extends StatefulWidget {
  const ProfitCalculatorWidget({super.key});

  @override
  State<ProfitCalculatorWidget> createState() => _ProfitCalculatorWidgetState();
}

class _ProfitCalculatorWidgetState extends State<ProfitCalculatorWidget> {
  late ProfitCalculatorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfitCalculatorModel());
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            _model.getSavings = true;
                            safeSetState(() {});
                            if ((int usage) {
                              return usage >= 0 && usage <= 150;
                            }(int.parse(_model.textController2.text))) {
                              _model.solarisBill = 999;
                              safeSetState(() {});
                            } else {
                              if ((int usage) {
                                return usage > 150 && usage <= 350;
                              }(int.parse(_model.textController2.text))) {
                                _model.solarisBill = 1999;
                                safeSetState(() {});
                              } else {
                                if ((int usage) {
                                  return usage > 350 && usage <= 500;
                                }(int.parse(_model.textController2.text))) {
                                  _model.solarisBill = 3699;
                                  safeSetState(() {});
                                } else {
                                  _model.solarisBill = 6999;
                                  safeSetState(() {});
                                }
                              }
                            }
